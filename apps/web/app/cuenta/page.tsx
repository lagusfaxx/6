...
import {
  ...
  Gift, Copy, Check, VenetianMask, ArrowRight, BadgeCheck,
} from "lucide-react";
...
export default function AccountPage() {
  ...
  if (isProfessional) {
    quickActions.push(
      ...
      { label: "Verificar identidad", description: "Consigue el sello verificada", href: "/cuenta/verificacion", icon: BadgeCheck, color: "text-emerald-400" },
