...
const NAV_ITEMS = [
  ...
  { href: "/admin/trials", label: "Pruebas Gratuitas", icon: Clock4 },
          ...
          <div className="px-4 sm:px-6 py-5 space-y-6">
            ...
            <div>
              ...
              <div className="grid gap-2 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
                ...
                <QuickAction href="/admin/trials" icon={Clock4} label="Pruebas Gratuitas" desc="Activas y vencidas" accent="amber" />
