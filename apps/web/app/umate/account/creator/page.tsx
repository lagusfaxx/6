...
import { Users, Heart, FileText, TrendingUp, AlertCircle, Loader2, Plus, Wallet } from "lucide-react";
    ...
    <div className="mx-auto max-w-4xl space-y-5 py-6">
      <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-black text-slate-900">Resumen de creadora</h1>
            <p className="text-sm text-slate-500">Gestiona contenido, ingresos y crecimiento desde un espacio claro.</p>
          </div>
          <Link href="/umate/account/content" className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-fuchsia-600 to-rose-500 px-4 py-2.5 text-sm font-bold text-white"><Plus className="h-4 w-4" />Publicar contenido</Link>
        </div>
      </section>
