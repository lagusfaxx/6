    ...
    <div className="space-y-5">
      ...
      <section className="grid gap-4 lg:grid-cols-[1.3fr_1fr]">
        <div className="space-y-4 min-w-0">
          <div className="card overflow-hidden p-4 min-w-0">
          ...
          <div className="card overflow-hidden p-4 min-w-0">
            ...
            <div className="mt-3 grid min-w-0 max-w-full gap-3 overflow-hidden">
              <div className="grid min-w-0 grid-cols-1 gap-2 sm:grid-cols-2">
                <label className="grid w-full min-w-0 gap-1 text-xs text-white/70">
                  Fecha de reserva
                  <input
                    className="input h-12 w-full min-w-0 px-3 py-2 text-sm"
                    type="date"
                    value={startDate}
                    min={minStartDate}
              ...
              <input className="input h-12 w-full min-w-0 px-3 py-2" value={note} onChange={(e) => setNote(e.target.value)} placeholder="Comentario para recepción" />
              <button className="btn-primary h-12 w-full min-w-0" disabled={busy} onClick={reserve}>{busy ? "Enviando..." : "Confirmar reserva"}</button>
            </div>
