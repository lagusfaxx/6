...
export default function LiveStreamPage() {
  ...
  const toggleViewerAudio = useCallback(() => {
    ...
    // Also resume AudioContext on unmute in case browser blocked it
              ...
              >
                {!isHost && (
                  <button
                    ...
                    className={`flex h-8 w-8 items-center justify-center rounded-xl backdrop-blur-xl transition-all border ${viewerMuted ? "bg-red-500/70 border-red-500/30 text-white" : "bg-black/50 border-white/10 text-white/50 hover:bg-black/70 hover:text-white"}`}
                  >
                ...
                <button
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-xl bg-black/50 text-white/50 backdrop-blur-xl transition-all hover:bg-black/70 hover:text-white border border-white/10"
                >
