...
const businessOptions: Array<{
  ...
  },
  {
    ...
    title: "Motel / Hotel",
    description:
      "Administra habitaciones, promociones y reservas desde el Panel Motel.",
    icon: Building2,
  },
  {
    key: "SHOP",
    title: "Tienda",
    description:
      "Comercios que venden artículos tipo sex shop se registran como Tienda.",
    icon: ShoppingBag,
  },
];
...
export default function RegisterClient() {
  ...
  const initialFromQuery = (
    searchParams.get("profileType") || "CLIENT"
  ).toUpperCase();
  const initialProfile = (
    ["CLIENT", "PROFESSIONAL", "ESTABLISHMENT", "SHOP"].includes(
      initialFromQuery,
    )
      ? initialFromQuery
      : "CLIENT"
  ...
  const [profileType, setProfileType] = useState<ProfileType>(initialProfile);
            ...
            onSuccess={() => {
              if (profileType !== "CLIENT") {
                if (profileType === "ESTABLISHMENT")
                  return { redirect: "/dashboard/motel" };
                setStep("photo");
        ...
        <div className="mt-6 grid gap-4">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
            ...
            <p className="mt-1 text-sm text-white/60">
              Puedes subir una foto ahora o más tarde desde tu panel.
            </p>
