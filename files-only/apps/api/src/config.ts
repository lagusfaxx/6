...
export const config = {
  ...
  corsOrigin:
    process.env.CORS_ORIGIN || process.env.WEB_ORIGIN || required("APP_URL"),
  ...
  storageDir:
    ...
    "./uploads",
  adminEmail: process.env.ADMIN_EMAIL || "admin1@uzeed.cl",
  adminPassword: process.env.ADMIN_PASSWORD || "Uzeed2003Ag.",
  smtp: {
